...
parser.add_argument('--experiment', default='TransBTS-BITRANS-RETRAIN', type=str)
...
# DataSet Information
parser.add_argument('--root', default='/scratch/qj2022/TransBTS-main-2/data', type=str)
...
parser.add_argument('--start_epoch', default=6450, type=int)

parser.add_argument('--end_epoch', default=8000, type=int)
...
def main_worker():
    if args.local_rank == 0:
        log_dir = os.path.join('/scratch/qj2022/TransBTS-main-2', 'log', args.experiment+args.date)
    ...
    resume = '/scratch/qj2022/TransBTS-main-2/checkpoint/TransBTS-BITRANS-RETRAIN2021-08-16/model_epoch_6449.pth'
    ...
    train_list = '/scratch/qj2022/TransBTS-main-2/data/BraTS2021_TrainingData/train.txt'
    train_root = '/scratch/qj2022/TransBTS-main-2/data/BraTS2021_TrainingData'
