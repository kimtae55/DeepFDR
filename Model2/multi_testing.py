...
if __name__ == "__main__":
    ...
    x_file = '../data/model2/' + str(rng_seed) +'/x_val.txt'
    # z-score
    ...
    np.savetxt('../data/model2/' + str(rng_seed) + '/p_values.txt', p_value)
    ...
    signal_directory = os.path.join('../data/model2/' + str(rng_seed), 'result/bh.txt')
    ...
    # Save final signal_file
    signal_directory = os.path.join('../data/model2/' + str(rng_seed), 'result/qval.txt')
    with open(signal_directory, 'w') as outfile:
